...
2. You have a number of related projects that depend on a similar set of libraries.
3. You want to update to a newer version of Python for new projects and tasks going forward. 
