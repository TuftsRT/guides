...
Data storage on the HPC Cluster is provided by the Tier 1 HPC research storage.  Details on this service can be found at (https://it.tufts.edu/research-data-storage).
