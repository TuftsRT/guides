...
- The old RHEL7 cluster software is available if you need an older version of software. Run the following to switch to the old modules. These modules may or may not work on the new cluster, and you should work to migrate to more recent versions of your software. To switch back to the current modules, run the command again. If you need assistance with this contact RT.
