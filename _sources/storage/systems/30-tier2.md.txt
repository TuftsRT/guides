...
1. Navigate to the source folder on the Tier 1 collection
1. Navigate to the destination folder on the Tier 2 collection
1. Select files and click **Transfer or Sync to**
